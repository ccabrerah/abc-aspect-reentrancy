...
public class CflowDepthPointcutExpr extends PointcutExpr implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public CflowDepthPointcutExpr clone() throws CloneNotSupportedException {
        CflowDepthPointcutExpr node = (CflowDepthPointcutExpr)super.clone();
    ...
    return node;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public CflowDepthPointcutExpr copy() {
      try {
          CflowDepthPointcutExpr node = (CflowDepthPointcutExpr)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public CflowDepthPointcutExpr fullCopy() {
        CflowDepthPointcutExpr res = (CflowDepthPointcutExpr)copy();
  ...
  public Pointcut pointcut() {
    ...
    // Declared in eaj.ast line 9

    public CflowDepthPointcutExpr() {
        super();
    ...
    // Declared in eaj.ast line 9
    public CflowDepthPointcutExpr(VarAccess p0, PointcutExpr p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
