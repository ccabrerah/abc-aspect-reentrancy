...
public class MethodDecl extends MemberDecl implements Cloneable, SimpleSet, Iterator {
    public void flushCache() {
        ...
        createSuperDispatchDelegate_TypeDecl_values = null;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public MethodDecl clone() throws CloneNotSupportedException {
        ...
        node.createSuperDispatchDelegate_TypeDecl_values = null;
  ...
  public void refined_EmitJimple_jimplify2() {
    ...
    // Declared in AdviceCodegen.jrag at line 143
  ...
  public void addAllEnclosedMethodSigs(LinkedList methods)
  {
    ...
    // Declared in AspectJCodegen.jrag at line 39


  public int category = MethodCategory.NORMAL;
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 97
    ...
    // Declared in AspectJCodegen.jrag at line 40

    public void jimplify2() {
    refined_EmitJimple_jimplify2();
...
private boolean refined_LookupMethod_moreSpecificThan_MethodDecl(MethodDecl m)
{
    ...
    // Declared in Privileged.jrag at line 62
...
if(accessibleFrom_TypeDecl_values == null) accessibleFrom_TypeDecl_values = new java.util.HashMap(4);
    ...
    if(type.isPrivileged())
      return true;
    return refined_AccessControl_accessibleFrom_TypeDecl(type);
  }
...
if(parameterDeclaration_String_values == null) parameterDeclaration_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public MethodDecl erasedMethod() {
    ...
    protected java.util.Map createSuperDispatchDelegate_TypeDecl_values;
    // Declared in IntertypeMethodCodegeneration.jrag at line 352
 @SuppressWarnings({"unchecked", "cast"})     public MethodDecl createSuperDispatchDelegate(TypeDecl qualifierType) {
        Object _parameters = qualifierType;
if(createSuperDispatchDelegate_TypeDecl_values == null) createSuperDispatchDelegate_TypeDecl_values = new java.util.HashMap(4);
        if(createSuperDispatchDelegate_TypeDecl_values.containsKey(_parameters))
            return (MethodDecl)createSuperDispatchDelegate_TypeDecl_values.get(_parameters);
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        MethodDecl createSuperDispatchDelegate_TypeDecl_value = createSuperDispatchDelegate_compute(qualifierType);
        if(isFinal && num == boundariesCrossed)
            createSuperDispatchDelegate_TypeDecl_values.put(_parameters, createSuperDispatchDelegate_TypeDecl_value);
        return createSuperDispatchDelegate_TypeDecl_value;
    }

    private MethodDecl createSuperDispatchDelegate_compute(TypeDecl qualifierType) {
    ...
    // Declared in IntertypeMethodNameAnalysis.jrag at line 174
 @SuppressWarnings({"unchecked", "cast"})     public boolean zaps(MethodDecl m) {
    ...
    private boolean zaps_compute(MethodDecl m) {  return m.zappedByMethodDecl(this);  }

    // Declared in IntertypeMethodNameAnalysis.jrag at line 177
 @SuppressWarnings({"unchecked", "cast"})     public boolean zappedByMethodDecl(MethodDecl m) {
    ...
    private boolean zappedByMethodDecl_compute(MethodDecl m) {  return m.overrides(this);  }

    // Declared in IntertypeMethodNameAnalysis.jrag at line 183
 @SuppressWarnings({"unchecked", "cast"})     public boolean zappedByIntertypeMethodDecl(IntertypeMethodDecl m) {
    ...
    // Declared in IntertypeMethodNameAnalysis.jrag at line 198
 @SuppressWarnings({"unchecked", "cast"})     public boolean couldOverride(MethodDecl m) {
    ...
    private boolean couldOverride_compute(MethodDecl m) {  return !isStatic() && !m.isPrivate() && m.accessibleFrom(hostType()) && 
     hostType().instanceOf(m.hostType()) && m.signature().equals(signature());  }
...
if(handlesException_TypeDecl_values == null) handlesException_TypeDecl_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public MethodDecl unknownMethod() {
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 155
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl visibilityContext() {
        TypeDecl visibilityContext_value = getParent().Define_TypeDecl_visibilityContext(this, null);
        return visibilityContext_value;
    }
