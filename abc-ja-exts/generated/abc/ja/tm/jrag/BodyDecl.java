...
public abstract class BodyDecl extends ASTNode<ASTNode> implements Cloneable {
  ...
  */
  ...
  public BodyDecl p(Parameterization parTypeDecl) {
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 233
  ...
  protected MethodDecl refined_IntertypeFieldCodegeneration_buildAccessor(Modifiers modifiers, TypeDecl type, 
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 249

  protected MethodDecl buildAccessor(Modifiers modifiers, TypeDecl type, 
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 254
  ...
  protected MethodDecl buildAccessor(Modifiers modifiers, TypeDecl type, 
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 265

 
  protected static Modifiers createAccessorModifiers(boolean isStatic) {
  ...
  public void jimplify2() {
    ...
    // Declared in Pointcuts.jrag at line 534
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in AspectJCodegen.jrag at line 128


    protected MethodDecl buildAccessor(Modifiers modifiers, TypeDecl type, 
                                                             String name, List parameters, Opt body, TypeDecl typeDecl) {
    MethodDecl m = refined_IntertypeFieldCodegeneration_buildAccessor(modifiers, type, name, parameters, body, typeDecl);
...
if(isDUafter_Variable_values == null) isDUafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean visibleTypeParameters() {
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 135
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean generate() {
    ...
    // Declared in Pointcuts.jrag at line 297
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet lookupMemberPointcut(String name) {
    ...
    private SimpleSet lookupMemberPointcut_compute(String name) {  return SimpleSet.emptySet;  }
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl hostType() {
    ...
    // Declared in AdviceCodegen.jrag at line 25
