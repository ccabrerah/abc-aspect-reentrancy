...
public class DeclareWarning extends BodyDecl implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public DeclareWarning clone() throws CloneNotSupportedException {
        DeclareWarning node = (DeclareWarning)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public DeclareWarning copy() {
      try {
          DeclareWarning node = (DeclareWarning)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public DeclareWarning fullCopy() {
        DeclareWarning res = (DeclareWarning)copy();
    ...
    // Declared in Declare.jrag at line 23
  ...
  public void typeCheck() {
    ...
    // Declared in DeclareCodegen.jrag at line 28
    ...
    // Declared in AspectJ.ast line 39
    ...
    // Declared in AspectJ.ast line 39
    public DeclareWarning(PointcutExpr p0, String p1) {
        setChild(p0, 0);
        setMessage(p1);
    }
    ...
    // Declared in AspectJ.ast line 39
    public DeclareWarning(PointcutExpr p0, beaver.Symbol p1) {
        setChild(p0, 0);
        setMessage(p1);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in DeclareCodegen.jrag at line 40
 @SuppressWarnings({"unchecked", "cast"})     public DeclareMessage declareMessage() {
    ...
    private DeclareMessage declareMessage_compute() {  return new DeclareMessage(DeclareMessage.WARNING,
                           getPointcutExpr().pointcut(),
                           getMessage(),
                           aspectClass(),
                           pos());  }

    // Declared in Pointcuts.jrag at line 112
    ...
    // Declared in Patterns.jrag at line 131
