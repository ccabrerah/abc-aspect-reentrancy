...
public class BeforeSpec extends AdviceSpec implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public BeforeSpec clone() throws CloneNotSupportedException {
        BeforeSpec node = (BeforeSpec)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public BeforeSpec copy() {
      try {
          BeforeSpec node = (BeforeSpec)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public BeforeSpec fullCopy() {
        BeforeSpec res = (BeforeSpec)copy();
    ...
    // Declared in AdviceCodegen.jrag at line 189
  ...
  public abc.weaving.aspectinfo.AdviceSpec adviceSpec() {
    ...
    // Declared in AspectJ.ast line 17
    public BeforeSpec(List<ParameterDeclaration> p0) {
        setChild(p0, 0);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in AdviceCodegen.jrag at line 34
