...
public abstract class Expr extends ASTNode<ASTNode> implements Cloneable {
  ...
  private boolean refined_LookupVariable_mayAccess(FieldDeclaration f) {
    if(f.isPublic()) 
      return true;
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in Privileged.jrag at line 102
    ...
    // Declared in IntertypeFieldNameAnalysis.jrag at line 146


    private boolean refined_IntertypeFieldNameAnalysis_mayAccess(FieldDeclaration f) {
    ...
    //return refined_LookupVariable_mayAccess(f);
  }
  ...
  // refine behavior to include unboxing of the value when needed
    ...
    // Declared in Privileged.jrag at line 137
    ...
    if(enclosingBodyDecl() != null && enclosingBodyDecl().hostType().isAspectDecl() && enclosingBodyDecl().hostType().isPrivileged())
      return true;
    return refined_IntertypeFieldNameAnalysis_mayAccess(f);
  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl assignConvertedType() {
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 42
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl visibilityContext() {
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 44
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl thisType() {
        TypeDecl thisType_value = getParent().Define_TypeDecl_thisType(this, null);
        return thisType_value;
    }
