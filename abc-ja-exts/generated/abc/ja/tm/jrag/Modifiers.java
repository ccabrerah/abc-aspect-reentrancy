...
public class Modifiers extends ASTNode<ASTNode> implements Cloneable {
    public void flushCache() {
        ...
        isPrivileged_computed = false;
        isPerThread_computed = false;
    }
     @SuppressWarnings({"unchecked", "cast"})  public Modifiers clone() throws CloneNotSupportedException {
        ...
        node.isPrivileged_computed = false;
        node.isPerThread_computed = false;
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 424
  ...
  public Modifiers makePublic() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 434
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in Privileged.jrag at line 29
...
if(numModifier_String_values == null) numModifier_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean hasDeprecatedAnnotation() {
    ...
    // Declared in Privileged.jrag at line 26
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPrivileged() {
        if(isPrivileged_computed)
            return isPrivileged_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        isPrivileged_value = isPrivileged_compute();
        if(isFinal && num == boundariesCrossed)
            isPrivileged_computed = true;
        return isPrivileged_value;
    }

    private boolean isPrivileged_compute() {  return numModifier("privileged") != 0;  }

    protected boolean isPerThread_computed = false;
    protected boolean isPerThread_value;
    // Declared in PerThread.jrag at line 25
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPerThread() {
        if(isPerThread_computed)
            return isPerThread_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        isPerThread_value = isPerThread_compute();
        if(isFinal && num == boundariesCrossed)
            isPerThread_computed = true;
        return isPerThread_value;
    }

    private boolean isPerThread_compute() {  return numModifier("perthread") != 0;  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl hostType() {
    ...
    // Declared in Privileged.jrag at line 23
 @SuppressWarnings({"unchecked", "cast"})     public boolean mayBePrivileged() {
        boolean mayBePrivileged_value = getParent().Define_boolean_mayBePrivileged(this, null);
        return mayBePrivileged_value;
    }
