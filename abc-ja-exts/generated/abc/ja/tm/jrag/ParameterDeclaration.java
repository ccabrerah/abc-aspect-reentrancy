...
public class ParameterDeclaration extends ASTNode<ASTNode> implements Cloneable, SimpleSet, Iterator, Variable {
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 199
  ...
  public ParameterDeclaration qualifiedCopy() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 390
  ...
  public Local local;
    ...
    // Declared in AspectJCodegen.jrag at line 317
  ...
  public Formal formal() {
    ...
    // Declared in ImplicitVariables.jrag at line 112

    public void errorIfImplicitName(String context)
    {
        String name = name();
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean isVariableArity() {
    ...
    // Declared in ImplicitVariables.jrag at line 74
 @SuppressWarnings({"unchecked", "cast"})     public boolean isImplicit() {
    ...
    private boolean isImplicit_compute() {  return false;  }
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean isCircular() {
        ...
        boolean isFinal = this.is$Final();
            ...
            do {
                ...
                CHANGE = false;
                boolean new_isCircular_value = getParent().Define_boolean_isCircular(this, null);
            ...
            if(isFinal && num == boundariesCrossed)
{
    ...
    // Declared in Pointcuts.jrag at line 61
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPointcutVariable() {
        boolean isPointcutVariable_value = getParent().Define_boolean_isPointcutVariable(this, null);
        return isPointcutVariable_value;
    }
