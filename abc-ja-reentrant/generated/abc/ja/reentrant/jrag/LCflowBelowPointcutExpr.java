...
public class LCflowBelowPointcutExpr extends PointcutExpr implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public LCflowBelowPointcutExpr clone() throws CloneNotSupportedException {
        LCflowBelowPointcutExpr node = (LCflowBelowPointcutExpr)super.clone();
    ...
    return node;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public LCflowBelowPointcutExpr copy() {
      try {
          LCflowBelowPointcutExpr node = (LCflowBelowPointcutExpr)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public LCflowBelowPointcutExpr fullCopy() {
        LCflowBelowPointcutExpr res = (LCflowBelowPointcutExpr)copy();
    ...
    // Declared in Declare.jrag at line 6
  ...
  public void collectNonStaticPointcuts(HashSet set) {
    ...
    // Declared in PointcutCodegen.jrag at line 7
    ...
    // Declared in reentrant.ast line 3

    public LCflowBelowPointcutExpr() {
        super();
    ...
    // Declared in reentrant.ast line 3
    public LCflowBelowPointcutExpr(PointcutExpr p0) {
        setChild(p0, 0);
    }
            ...
            if(isFinal && num == boundariesCrossed)
{
    ...
    // Declared in Pointcuts.jrag at line 12
