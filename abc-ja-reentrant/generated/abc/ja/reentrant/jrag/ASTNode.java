...
// Generated with JastAdd II (http://jastadd.cs.lth.se) version R20080317
...
public class ASTNode<T extends ASTNode> extends beaver.Symbol  implements Cloneable, Iterable<T> {
  ...
  */
  ...
  private static int replacePos = 0;
    ...
    // Declared in IntertypeDecls.jrag at line 28

  protected void generateIntertypeDecls() {
    for(int i = 0; i < getNumChild(); i++)
      getChild(i).generateIntertypeDecls();
  }

    // Declared in IntertypeDecls.jrag at line 57
  ...
  protected void collectIntertypeDecls(HashMap map) {
    ...
    // Declared in IntertypeDecls.jrag at line 86
  ...
  protected void collectIntertypeParentDecls(HashMap map) {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 112
  ...
  public ASTNode boundCopy() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 222


  public void generateSuperDispatchDelegate(TypeDecl typeDecl) {
    for(int i = 0; i < getNumChild(); i++)
      getChild(i).generateSuperDispatchDelegate(typeDecl);
  }

    // Declared in IntertypeMethodCodegeneration.jrag at line 335
...
/*
  ...
  protected static List copyParameterList(List l) {
    List list = new List();
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 343

  protected static List copyTypeList(List l) {
    List list = new List();
    for(int i = 0; i < l.getNumChild(); i++) {
  ...
  public static soot.Value emitConstant(Constant constant) {
    ...
    // Declared in AdviceCodegen.jrag at line 138
  ...
  public void addAllEnclosedMethodSigs(LinkedList methods)
  {
    for (int i = 0; i < getNumChild(); i++)
      getChild(i).addAllEnclosedMethodSigs(methods);
  }

    // Declared in AspectJCodegen.jrag at line 27


  public static GlobalAspectInfo globalAspectInfo() {
    return abc.main.Main.v().getAbcExtension().getGlobalAspectInfo();
  }

    // Declared in AspectJCodegen.jrag at line 331

  
  // Build a polyglot Position that corresponds to the current position
  public polyglot.util.Position pos() {
    return new polyglot.util.Position(sourceFile(), lineNumber());
  }

    // Declared in Declare.jrag at line 59
  ...
  public void collectNonStaticPointcuts(HashSet set) {
    ...
    // Declared in PatternsCodegen.jrag at line 458


    protected static Set superTypes(SootClass sc)
    {
    ...
    // Declared in PatternsCodegen.jrag at line 465


    protected static void addSuperTypes(SootClass sc, Set supertypes)
    {
        supertypes.add(sc);
    ...
    // Declared in SymbolCodegen.jrag at line 181


    protected void lookupAllChildren()
    {
    for (int i = 0; i < getNumChild(); i++)
  ...
  public void setParent(ASTNode node) {
    ...
    protected static int duringPatterns = 0;

    // Declared in ASTNode.ast at line 162

    protected static boolean duringPatterns() {
        if(duringPatterns == 0) {
            return false;
        }
        else {
    ...
    protected static int duringrewritePointcuts = 0;

    // Declared in ASTNode.ast at line 261

    protected static boolean duringrewritePointcuts() {
        if(duringrewritePointcuts == 0) {
            return false;
        }
        else {
            state.pop();
    ...
    public static void reset() {
        ...
        if(duringPatterns != 0) {
            System.out.println("Warning: resetting duringPatterns");
            duringPatterns = 0;
        }
        if(duringDefiniteAssignment != 0) {
        ...
        if(duringrewritePointcuts != 0) {
            System.out.println("Warning: resetting duringrewritePointcuts");
            duringrewritePointcuts = 0;
        }
        if(duringSyntacticClassification != 0) {
    ...
    // Declared in ASTNode.ast at line 365
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean definesLabel() {
    ...
    // Declared in DeclarePrecedence.jrag at line 42
 @SuppressWarnings({"unchecked", "cast"})     public AspectDecl nextAspectBelow(int start) {
    ...
    private AspectDecl nextAspectBelow_compute(int start) {
    ...
    // Declared in DeclarePrecedence.jrag at line 53
 @SuppressWarnings({"unchecked", "cast"})     public AspectDecl nextAspectRight() {
        AspectDecl nextAspectRight_value = nextAspectRight_compute();
        return nextAspectRight_value;
    }

    private AspectDecl nextAspectRight_compute() {
    ...
    // Declared in ImplicitVariables.jrag at line 158
 @SuppressWarnings({"unchecked", "cast"})     public boolean refersTo(Variable decl) {
        boolean refersTo_Variable_value = refersTo_compute(decl);
        return refersTo_Variable_value;
    }

    private boolean refersTo_compute(Variable decl) {
        for (int i = 0; i < getNumChild(); i++)
...
public ASTNode rewriteTo() {
    ...
    public ParameterDeclaration Define_ParameterDeclaration_implicitVarDecl(ASTNode caller, ASTNode child, String name) {
        return getParent().Define_ParameterDeclaration_implicitVarDecl(this, caller, name);
    }
    ...
    public Collection Define_Collection_intertypeParentDecls(ASTNode caller, ASTNode child, TypeDecl type) {
        return getParent().Define_Collection_intertypeParentDecls(this, caller, type);
    }
    ...
    public Collection Define_Collection_declarePrecedence(ASTNode caller, ASTNode child) {
        return getParent().Define_Collection_declarePrecedence(this, caller);
    }
    ...
    public Collection Define_Collection_declareParentsImplements(ASTNode caller, ASTNode child) {
        return getParent().Define_Collection_declareParentsImplements(this, caller);
    }
    ...
    public AspectDecl Define_AspectDecl_firstAspect(ASTNode caller, ASTNode child) {
        return getParent().Define_AspectDecl_firstAspect(this, caller);
    }
    ...
    public Collection Define_Collection_intertypeDecls(ASTNode caller, ASTNode child, TypeDecl type) {
        return getParent().Define_Collection_intertypeDecls(this, caller, type);
    }
    ...
    public Collection Define_Collection_declareParentsExtends(ASTNode caller, ASTNode child) {
        return getParent().Define_Collection_declareParentsExtends(this, caller);
    }
