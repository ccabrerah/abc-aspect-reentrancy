...
public class CastPointcutExpr extends PointcutExpr implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public CastPointcutExpr clone() throws CloneNotSupportedException {
        CastPointcutExpr node = (CastPointcutExpr)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public CastPointcutExpr copy() {
      try {
          CastPointcutExpr node = (CastPointcutExpr)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public CastPointcutExpr fullCopy() {
        CastPointcutExpr res = (CastPointcutExpr)copy();
  ...
  public Pointcut pointcut() {
    ...
    // Declared in eaj.ast line 5

    public CastPointcutExpr() {
        super();
    ...
    // Declared in eaj.ast line 5
    public CastPointcutExpr(Pattern p0) {
        setChild(p0, 0);
    }
