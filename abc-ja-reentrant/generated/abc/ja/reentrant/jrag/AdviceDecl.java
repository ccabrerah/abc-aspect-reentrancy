...
public class AdviceDecl extends BodyDecl implements Cloneable {
  ...
  public void jimplify2() {
    ...
    // Declared in rewritePointcuts.jrag at line 7
 //here will be stored the level declared for an aspect

    public boolean rewroteToAddLevel = false;

    // Declared in rewritePointcuts.jrag at line 41



    //rewrite to add reentrancy control
    public boolean addedReentrancyCheck = false;
...
public ASTNode rewriteTo() {
    // Declared in rewritePointcuts.jrag at line 10
    if(!this.rewroteToAddLevel && this.addedReentrancyCheck) {
        duringrewritePointcuts++;
        ASTNode result = rewriteRule0();
        duringrewritePointcuts--;
        return result;
    }

    // Declared in rewritePointcuts.jrag at line 44
    if(!this.addedReentrancyCheck) {
        duringrewritePointcuts++;
    ...
    // Declared in rewritePointcuts.jrag at line 10
    private AdviceDecl rewriteRule0() {
{
    ...
    // Declared in rewritePointcuts.jrag at line 44
    private AdviceDecl rewriteRule1() {
{
