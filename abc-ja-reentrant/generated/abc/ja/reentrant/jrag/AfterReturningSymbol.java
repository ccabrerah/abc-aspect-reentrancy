...
public class AfterReturningSymbol extends SymbolKind implements Cloneable {
    public void flushCache() {
        super.flushCache();
    }
     @SuppressWarnings({"unchecked", "cast"})  public AfterReturningSymbol clone() throws CloneNotSupportedException {
        AfterReturningSymbol node = (AfterReturningSymbol)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public AfterReturningSymbol copy() {
      try {
          AfterReturningSymbol node = (AfterReturningSymbol)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public AfterReturningSymbol fullCopy() {
        AfterReturningSymbol res = (AfterReturningSymbol)copy();
    ...
    // Declared in tm.ast line 13

    public AfterReturningSymbol() {
        super();
    ...
    // Declared in tm.ast line 13
    public AfterReturningSymbol(Opt<VarAccess> p0) {
        setChild(p0, 0);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in SymbolCodegen.jrag at line 38
 @SuppressWarnings({"unchecked", "cast"})     public String kind() {
        String kind_value = kind_compute();
        return kind_value;
    }

    private String kind_compute() {  return "afterReturning";  }

    // Declared in SymbolCodegen.jrag at line 85
