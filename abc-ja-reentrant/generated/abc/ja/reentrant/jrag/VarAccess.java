...
public class VarAccess extends Access implements Cloneable {
  ...
  public void refined_Transformations_transformation() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 128
  ...
  public soot.Value refined_Expressions_emitStore(Body b, soot.Value lvalue, soot.Value rvalue) {
    ...
    // Declared in SymbolCodegen.jrag at line 186

    protected void lookupAllChildren() { decl(); }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 72
  ...
  // TODO: the same for methods and constructors
    ...
    public soot.Value refined_GenericsCodegen_eval(Body b) {
    Variable v = decl();
    soot.Value result;
    if(v instanceof FieldDeclaration) {
    ...
    public soot.Value refined_GenericsCodegen_emitStore(Body b, soot.Value lvalue, soot.Value rvalue) {
    Variable v = decl();
    if(v instanceof FieldDeclaration) {
      FieldDeclaration f = ((FieldDeclaration)v).erasedField();
      if(requiresAccessor()) {
    ...
    // Declared in IntertypeJimple15.jrag at line 23
  public soot.Value eval(Body b) {
    ...
    return refined_GenericsCodegen_eval(b);

  }

    // Declared in IntertypeJimple15.jrag at line 46
  public soot.Value emitStore(Body b, soot.Value lvalue, soot.Value rvalue) {
    ...
    return refined_GenericsCodegen_emitStore(b, lvalue, rvalue);
  }

    // Declared in InnerClasses.jrag at line 353
private boolean refined_InnerClasses_requiresAccessor()
{
    Variable v = decl();
    if(!(v instanceof FieldDeclaration))
      return false;
...
if(isDAafter_Variable_values == null) isDAafter_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean unassignedEverywhere(Variable v, TryStmt stmt) {
    ...
    // Declared in IntertypeFieldNameAnalysis.jrag at line 69
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean isVariable() {
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 305
 @SuppressWarnings({"unchecked", "cast"})     public boolean requiresAccessor() {
    ...
    return refined_InnerClasses_requiresAccessor();
  }
...
if(base_Body_values == null) base_Body_values = new java.util.HashMap(4);
    ...
    // Declared in ImplicitVariables.jrag at line 165
 @SuppressWarnings({"unchecked", "cast"})     public boolean refersTo(Variable decl) {
    ...
    private boolean refersTo_compute(Variable decl) {  return decl() == decl;  }

    // Declared in PointcutsCodegen.jrag at line 264
 @SuppressWarnings({"unchecked", "cast"})     public String variableName() {
    ...
    private String variableName_compute() {  return name();  }
