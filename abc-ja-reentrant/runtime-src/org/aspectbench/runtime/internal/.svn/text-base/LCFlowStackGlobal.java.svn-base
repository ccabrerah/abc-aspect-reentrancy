...
public class LCFlowStackGlobal {
    ...
    public static class LCFlowStackRef implements LCFlowStackInterface.Ref {
    ...
    public static class LCFlowStackInt implements LCFlowStackInterface.Int {
    ...
    public static class LCFlowStackLong implements LCFlowStackInterface.Long {
    ...
    public static class LCFlowStackFloat implements LCFlowStackInterface.Float {
    ...
    public static class LCFlowStackDouble implements LCFlowStackInterface.Double {
