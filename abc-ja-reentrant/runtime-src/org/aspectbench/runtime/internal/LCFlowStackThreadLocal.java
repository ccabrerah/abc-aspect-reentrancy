 ...
 */
public class LCFlowStackThreadLocal {

	public static class Ref extends ThreadLocal implements LCFlowStackInterface.Ref {
	...
	public static class Int extends ThreadLocal implements LCFlowStackInterface.Int {
		private Thread first_thread = Thread.currentThread();
	...
	public static class Long extends ThreadLocal implements LCFlowStackInterface.Long {
		private Thread first_thread = Thread.currentThread();
	...
	public static class Float extends ThreadLocal implements LCFlowStackInterface.Float {
		private Thread first_thread = Thread.currentThread();
	...
	public static class Double extends ThreadLocal implements LCFlowStackInterface.Double {
		private Thread first_thread = Thread.currentThread();
