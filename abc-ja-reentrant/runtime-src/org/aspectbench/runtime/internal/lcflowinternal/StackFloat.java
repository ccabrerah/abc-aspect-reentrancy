...
public class StackFloat extends StackCommon {
    ...
    public static class Cell extends CommonCell {
        ...
        public Cell(Cell prev, float elem, int level) {
            StackCommon.debug( "creating (float) cell with level: "+ level +" element: "+ elem);
            this.prev = prev;
            this.elem = elem;
            this.level = level;
        }
