...
public class IfResidue extends Residue {
	...
	Stmt currStmt = begin;
        ...
        Stmt levelUpStmt = Jimple.v().newInvokeStmt(Jimple.v().newStaticInvokeExpr(Scene.v().getMethod("<abc.reentrant.runtime.Level: void forceUnmanagedUp3()>").makeRef()));
	...
	units.insertAfter(abort,assign);
        ...
        Stmt levelDownStmt = Jimple.v().newInvokeStmt(Jimple.v().newStaticInvokeExpr(Scene.v().getMethod("<abc.reentrant.runtime.Level: void forceUnmanagedDown3()>").makeRef())); //ok??
