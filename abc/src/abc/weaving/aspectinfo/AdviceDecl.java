...
public class AdviceDecl extends AbstractAdviceDecl {
    ...
    public Chain makeAdviceExecutionStmts
        ...
        Stmt levelUpStmt = Jimple.v().newInvokeStmt(Jimple.v().newStaticInvokeExpr(Scene.v().getMethod("<abc.reentrant.runtime.Level: void forceUnmanagedUp2()>").makeRef())); //ok??
	...
	//aspect pop code
        ...
        Stmt levelDownStmt = Jimple.v().newInvokeStmt(Jimple.v().newStaticInvokeExpr(Scene.v().getMethod("<abc.reentrant.runtime.Level: void forceUnmanagedDown2()>").makeRef())); //ok??
