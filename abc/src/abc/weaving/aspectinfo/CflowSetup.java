...
/* REENTRANCY_LEVELS_EXTENSION 
 ...
 ATTENTION!!
 this code is modified: lots of private members are now protected or public (we had to extend this)
...
public class CflowSetup extends AbstractAdviceDecl {
    ...
    protected boolean isBelow;
    protected int depth;
    protected List/*<Var>*/ actuals;
    protected CflowCodeGenUtils.CflowCodeGen codeGen = null;
    ...
    protected CflowSetup(Aspect aspct, Pointcut pc, boolean isBelow,
    ...
    public void debugInfo(String prefix, StringBuffer sb) {
        ...
        sb.append(prefix + " special: " + (isBelow ? "cflowbelow" : "cflow") + " setup\n");
    }
    ...
    public static class CflowSetupBound extends WeavingVar {
        ...
        public Stmt set(LocalGeneratorEx localgen, Chain units, Stmt begin,
            ...
            if (loc == null) {
                loc = localgen.generateLocal(type, "adviceformal");
            }
    ...
    public class CflowBoundVars implements WeavingEnv {
        ...
        protected Hashtable setupbounds = new Hashtable();
        ...
        public WeavingVar getWeavingVar(Var v) {
            ...
            if (index == -1) {
                throw new InternalCompilerError("Variable " + v.getName() + " not found in context",
                        v.getPosition());
            }
    ...
    protected SootFieldRef cflowStack = null;
    protected SootMethod preClinit = null;
    ...
    protected Map/*SootMethod->Local*/ methodCflowLocals = new HashMap();
    protected Map/*SootMethod->Local*/ methodCflowThreadLocals = new HashMap();
    ...
    protected Stmt getMethodFirstSafeCflowStatement(SootMethod m) {
        ...
        if (cl.equals(getAspect().getInstanceClass().getSootClass()) &&
            ...
            while (it.hasNext()) {
                ...
                if (!(news instanceof IdentityStmt)) {
                    break;
                }
                s = news;
            }
    ...
    public Chain makeAdviceExecutionStmts(AdviceApplication adviceappl, LocalGeneratorEx localgen, WeavingContext wc) {
        ...
        Local cflowLocal =
                (abc.main.options.OptionsParser.v().cflow_share_thread_locals() ? getMethodCflowThreadLocal(localgen, m)
        ...
        if (cswc.doBefore) {
            ...
            Chain getInstance =
                    (abc.main.options.OptionsParser.v().cflow_share_thread_locals() ? codeGen().genInitLocalLazily(localgen, cflowLocal, cflowInstance)
    ...
    protected List uses/*<CflowPointcut>*/ = new ArrayList();
    ...
    public List/*<CflowPointcut>*/ getUses() {
        return uses;
    }
}
