...
/* REENTRANCY_LEVELS_EXTENSION 

members were made public. To allow for easier inheritance on GlobalLCflowSetupFactory
...
public class GlobalCflowSetupFactory {
	...
	public static void debugMapping(Hashtable/*<Var,PointcutVarEntry>*/ renaming) {
		if (Debug.v().debugCflowSharing) {
	...
	public static class CfsStore {
		public static class CfsEntry {
			public Pointcut pc;
			public CflowSetup cfs;
			public Hashtable/*<String,AbcType>*/ typeMap;
			
			public Pointcut getPointcut() { return pc; }
			public CflowSetup getCfs() { return cfs; }
			public Hashtable/*<String,AbcType>*/ getTypeMap() { return typeMap; }
			
			public CfsEntry(Pointcut pc, Hashtable/*<String,AbcTy?>*/ typeMap, CflowSetup cfs) {
		...
		public static List/*<CfsEntry>*/ cfsStore = new ArrayList();
		 ...
		 */
		public static void put(Pointcut pc, Hashtable/*<String, AbcType>*/ typeMap, CflowSetup cfs) {
		 ...
		 */
		public static int find(Pointcut pc, boolean isBelow, int depth, Unification unification) {
			int index = 0;
		...
		public static CfsContainer findAndUnify(Aspect a,
									  Pointcut pc, 
									  boolean isBelow, 
									  int depth, 
									  Position pos,
...
//					if (!unification.getPointcut().canRenameTo(p.getPointcut(), renaming)) 
		...
		public static CfsContainer findExisting
	...
	public static Formal findFormal(String fv, List/*<Formal>*/ fs) {
	...
	public static void makeTypeMap(List/*<Formal>*/ fs, Hashtable/*<String,AbcType>*/ outTypeMap) {
		Iterator it = fs.iterator();
		while (it.hasNext()) {
			Formal newf = (Formal)it.next();
    ...
    public static boolean canShare(boolean isBelow, int depth, CflowSetup cfs) {
    ...
    public static CfsContainer buildNewCfs(
    		Aspect a, Pointcut pc, boolean isBelow, Hashtable typeMap, Position pos, int depth) {
    ...
    static public class CfsContainer { /*TEST class made public*/
    	public CflowSetup cfs = null;
    	public Hashtable/*<Var,PointcutVarEntry>*/ renaming = null;
