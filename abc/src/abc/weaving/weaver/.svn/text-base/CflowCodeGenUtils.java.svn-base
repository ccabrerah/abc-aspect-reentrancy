...
/* REENTRANCY_LEVELS_EXTENSION CodeGenUtils classes and members made public to allow inheritance */
...
public class CflowCodeGenUtils {
    ...
    public static class CodeGenUtils {
         ...
         */
        public Chain genCopy(LocalGeneratorEx localgen, Local from, Local to) {
         ...
         */
        public Chain genCopyFromArray(LocalGeneratorEx localgen, Local fromArray, int index, Local to) {
         ...
         */
        public Chain genCopyToArray(LocalGeneratorEx localgen, Local from, Local toArray, int index) {
         ...
         */
        public boolean primTypeNeedCast(PrimType from, PrimType to) {
         ...
         */
        public boolean needCast(Type from, Type to) {
            ...
            if (from instanceof ArrayType && to instanceof ArrayType) {
                return needCast(((ArrayType) from).baseType,
         ...
         */
        public Local genCast(LocalGeneratorEx localgen, Chain c, Local from, Type toType, Stmt stmt) {
         ...
         */
        public Chain genCopyCast(LocalGeneratorEx localgen, Local from, Local to) {
            Type fromType = from.getType();
         ...
         */
        public Chain genDecision(LocalGeneratorEx localgen, Expr testIfTrue, Local result, Stmt succeed, Stmt fail) {
            Stmt resfalse =
                    Jimple.v().newAssignStmt(
                    result,
                    IntConstant.v(0));
            ...
            Stmt jumpAfterSetIfValid =
                    (succeed == null) ? Jimple.v().newGotoStmt(nop) : Jimple.v().newGotoStmt(succeed);
            Stmt jumpAfterSetIfNotValid =
                    (fail == null) ? Jimple.v().newGotoStmt(nop) : Jimple.v().newGotoStmt(fail);
     ...
     */
    public static class CflowCounterGlobalUtils {
     ...
     * TEST members made public
     */
    public static class CflowStackGlobalUtils {

        public CflowStackGlobalUtils(String elemType) {// TEST need to access this from LCflowStackGlobalUtils
            this.elemType = elemType;
        }
        public String elemType; 
        public SootClass factoryClass = null;
        ...
        public final String STACKCELL_REF = "Ref";
        public final String STACKCELL_INT = "Int";
        public final String STACKCELL_LONG = "Long";
        public final String STACKCELL_FLOAT = "Float";
        public final String STACKCELL_DOUBLE = "Double";

        public String fromType(Type t) {
            if (t instanceof RefType) {
                return STACKCELL_REF;
            } else if (t instanceof BooleanType) {
                return STACKCELL_INT;
                ...
                return STACKCELL_LONG;
            } else if (t instanceof CharType) {
                return STACKCELL_INT;
            } else if (t instanceof FloatType) {
                return STACKCELL_FLOAT;
            } else if (t instanceof DoubleType) {
                return STACKCELL_DOUBLE;
            } else {
        ...
        public Type toType(String s) {
            ...
            if (s.equals(STACKCELL_REF)) {
                return objectType();
            } else if (s.equals(STACKCELL_INT)) {
                return IntType.v();
            } else if (s.equals(STACKCELL_LONG)) {
                return LongType.v();
            } else if (s.equals(STACKCELL_FLOAT)) {
                return FloatType.v();
            } else if (s.equals(STACKCELL_DOUBLE)) {
                return DoubleType.v();
            } else {
        ...
        public SootClass typedStackClass(Type t) {
            return typedStackClass(fromType(t));
        }

        public SootClass typedStackClass(String celltype) {
            return Scene.v().getSootClass("org.aspectbench.runtime.internal.CflowStackInterface$" + celltype);
        }

        public RefType typedStackType(Type t) {
            return typedStackType(fromType(t));
        }

        public RefType typedStackType(String celltype) {
            return typedStackClass(celltype).getType();
        }

        public SootClass threadStackClass(Type t) {
            return threadStackClass(fromType(t));
        }

        public SootClass threadStackClass(String celltype) {
            return Scene.v().getSootClass("org.aspectbench.runtime.internal.cflowinternal.Stack" + celltype);
        }

        public RefType threadStackType(Type t) {
            return threadStackType(fromType(t));
        }

        public RefType threadStackType(String celltype) {
            return threadStackClass(celltype).getType();
        }

        public SootClass threadStackCellClass(Type t) {
            return threadStackCellClass(fromType(t));
        }

        public SootClass threadStackCellClass(String celltype) {
            return Scene.v().getSootClass("org.aspectbench.runtime.internal.cflowinternal.Stack" + celltype + "$Cell");
        }

        public RefType threadStackCellType(Type t) {
            return threadStackCellType(fromType(t));
        }

        public RefType threadStackCellType(String celltype) {
            return threadStackCellClass(celltype).getType();
        }

        public SootMethodRef threadStackCellConstructor(Type t) {
            return threadStackCellConstructor(fromType(t));
        }
        ...
        public SootMethodRef makeMethod(Type t) {
            return makeMethod(fromType(t));
        }

        public SootMethodRef makeMethod(String celltype) {
            return Scene.v().makeMethodRef(
                    factoryClass(),
                    "makeStack" + celltype,
                    new ArrayList(),
        ...
        public SootMethodRef getMethod(Type t) {
            return getMethod(fromType(t));
        }

        public SootMethodRef getMethod(String celltype) {
            return Scene.v().makeMethodRef(
        ...
        public SootFieldRef threadStackField(Type t) {
            return threadStackField(fromType(t));
        }

        public SootFieldRef threadStackField(String celltype) {
            return Scene.v().makeFieldRef(
        ...
        public SootFieldRef threadStackPrevField(Type t) {
            return threadStackPrevField(fromType(t));
        }

        public SootFieldRef threadStackPrevField(String celltype) {
            return Scene.v().makeFieldRef(
        ...
        public SootFieldRef threadStackElemField(Type t) {
            return threadStackElemField(fromType(t));
        }

        public SootFieldRef threadStackElemField(String celltype) {
            return Scene.v().makeFieldRef(
                    threadStackCellClass(celltype),
                    "elem",
                    toType(celltype),
        ...
        public SootFieldRef singleThreadedStackField(Type t) {
            return singleThreadedStackField(fromType(t));
        }

        public SootFieldRef singleThreadedStackField(String celltype) {
            return Scene.v().makeFieldRef(
                    threadStackClass(celltype),
                    "top",
                    threadStackCellType(celltype),
    ...
    public static class CflowCounterSingleThreadedCodeGen extends CflowCodeGen {
        ...
        public Type getCflowType() {
            return util.threadCounterClass().getType();
        }
     ...
     */
    public static abstract class CflowStackCommonCodeGen extends CflowCodeGen {

        protected CflowStackGlobalUtils util = null;

        public Type getCflowType() {
            return util.typedStackType(elemType);
        }
        ...
        protected Value getStackFieldInstance(boolean isSingleThreaded, boolean useStaticField, Local cFlowLocal) {
            if (useStaticField) {
        ...
        protected Chain protogenPeek(LocalGeneratorEx localgen,
                Local cFlowLocal, List/*<Local>*/ targets, boolean isSingleThreaded, boolean useStaticField) {
    ...
    public static class CflowStackGlobalCodeGen extends CflowStackCommonCodeGen {
        ...
        protected CflowStackGlobalCodeGen() { //TEST: made protected to have a cleaner way to reuse this code. I Don't think that this would cause problems, as this class seems to not have been intended to work as a singleton
        }
    ...
    public static class CflowStackSingleThreadedCodeGen extends CflowStackCommonCodeGen {
        ...
        public Type getCflowType() {
            return util.threadStackType(elemType);
        }
    ...
    public static class CflowStackSingleThreadedStaticFieldCodeGen extends CflowStackCommonCodeGen {
        ...
        public Type getCflowType() {
            return util.threadStackCellClass(elemType).getType();
        }
