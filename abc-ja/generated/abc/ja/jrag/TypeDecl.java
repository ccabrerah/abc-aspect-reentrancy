...
public abstract class TypeDecl extends ASTNode<ASTNode> implements Cloneable, SimpleSet, Iterator, VariableScope {
    public void flushCache() {
        ...
        precedes_TypeDecl_values = null;
        introducedConstructors_computed = false;
        introducedConstructors_value = null;
        intertypeDecls_computed = false;
        intertypeDecls_value = null;
        intertypeParentDecls_computed = false;
        intertypeParentDecls_value = null;
        introducedFields_computed = false;
        introducedFields_value = null;
        introducedMethods_computed = false;
        introducedMethods_value = null;
        ...
        abcClass_value = null;
        abcType_computed = false;
        abcType_value = null;
        inheritedPointcuts_computed = false;
        inheritedPointcuts_value = null;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public TypeDecl clone() throws CloneNotSupportedException {
        ...
        node.precedes_TypeDecl_values = null;
        node.introducedConstructors_computed = false;
        node.introducedConstructors_value = null;
        node.intertypeDecls_computed = false;
        node.intertypeDecls_value = null;
        node.intertypeParentDecls_computed = false;
        node.intertypeParentDecls_value = null;
        node.introducedFields_computed = false;
        node.introducedFields_value = null;
        node.introducedMethods_computed = false;
        node.introducedMethods_value = null;
        ...
        node.abcType_computed = false;
        node.abcType_value = null;
        node.inheritedPointcuts_computed = false;
        node.inheritedPointcuts_value = null;
  ...
  public FieldDeclaration refined_BoundNames_addMemberField(FieldDeclaration f) {
    addBodyDecl(f);
  ...
  public void transformation() {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 501

  public boolean mustBePublic = false;

    // Declared in IntertypeMethodErrorCheck.jrag at line 201

    protected void checkMethods(MethodDecl m, MethodDecl decl) {
      ASTNode target = m;
          if(!m.isStatic() && decl.isStatic())
            target.error("an instance method may not override a static method");
          if(m.isStatic() && !decl.isStatic())
  ...
  private HashMap createEnumIndexMap = null;
    ...
    // Declared in AdviceCodegen.jrag at line 29


  public int adviceCounter = 0;

    // Declared in PatternsCodegen.jrag at line 644

    public void addSuperTypes(Set set) { }

    // Declared in Pointcuts.jrag at line 499


    public void addInheritedPointcuts(Set visited, Set names) { }

    // Declared in Pointcuts.jrag at line 529

    protected void addLocalPointcuts(Set names)
    {
        for (int i = 0; i < getNumBodyDecl(); i++)
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 13
  ...
  // make sure that fields added using addMemberField are visible without having to flush all name binding attributes
    ...
    f = refined_BoundNames_addMemberField(f);
    if(localFieldsMap_value != null)
      localFieldsMap_value.put(f.name(), f);
    return f;
  }

    // Declared in IntertypeMethodErrorCheck.jrag at line 157


    public void refined_IntertypeMethodErrorCheck_typeCheck() {
    ...
    // Declared in Pointcuts.jrag at line 465




    // check for abstract pointcuts which should be overridden
      public void refined_Pointcuts_typeCheck()
    {
        refined_IntertypeMethodErrorCheck_typeCheck();
    ...
    // Declared in IntertypeJimple15.jrag at line 116
  public void typeCheck() {
    refined_Pointcuts_typeCheck();
...
private boolean refined_AccessControl_accessibleFromExtend_TypeDecl(TypeDecl type)
{
    if(type == this)
      return true;
    if(isInnerType()) { 
...
private boolean refined_AccessControl_accessibleFrom_TypeDecl(TypeDecl type)
{
    if(type == this)
      return true;
    if(isInnerType()) { 
...
private HashMap refined_LookupMethod_localMethodsSignatureMap()
{
...
private SimpleSet refined_LookupVariable_localFields_String(String name)
...
{ return null; }
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 51
private boolean refined_DeclareParentsAnalysis_accessibleFrom_TypeDecl(TypeDecl type)
{
    if(refined_AccessControl_accessibleFrom_TypeDecl(type))
      return true;
    ...
    // Declared in AspectJCodegen.jrag at line 186
private SootClass refined_AspectJCodegen_getSootClassDecl()
{
...
if(accessibleFromPackage_String_values == null) accessibleFromPackage_String_values = new java.util.HashMap(4);
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 61
...
if(accessibleFromExtend_TypeDecl_values == null) accessibleFromExtend_TypeDecl_values = new java.util.HashMap(4);
    ...
    if(refined_AccessControl_accessibleFromExtend_TypeDecl(type))
      return true;
    if(type instanceof ClassDecl && ((ClassDecl)type).introducedSuperclass() == this)
      return true;
    return false;
    ...
    // Declared in Privileged.jrag at line 37
...
if(accessibleFrom_TypeDecl_values == null) accessibleFrom_TypeDecl_values = new java.util.HashMap(4);
    ...
    if(type.isPrivileged())
      return true;
    return refined_DeclareParentsAnalysis_accessibleFrom_TypeDecl(type);
  }
...
if(mayCatch_TypeDecl_values == null) mayCatch_TypeDecl_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Collection lookupSuperConstructor() {
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 139
...
if(unqualifiedLookupMethod_String_values == null) unqualifiedLookupMethod_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet localMethodsSignature(String signature) {
    ...
    // Declared in IntertypeMethodNameAnalysis.jrag at line 60
 @SuppressWarnings({"unchecked", "cast"})     public HashMap localMethodsSignatureMap() {
    ...
    HashMap map = refined_LookupMethod_localMethodsSignatureMap();
...
if(memberTypes_String_values == null) memberTypes_String_values = new java.util.HashMap(4);
    ...
    // Declared in IntertypeFieldNameAnalysis.jrag at line 58
...
if(localFields_String_values == null) localFields_String_values = new java.util.HashMap(4);
    ...
    SimpleSet fields = refined_LookupVariable_localFields_String(name);
            ...
            if(isFinal && num == boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public String referenceClassFieldName() {
    ...
    // Declared in AspectErrorCheck.jrag at line 19
 @SuppressWarnings({"unchecked", "cast"})     public boolean isAspectDecl() {
    ...
    private boolean isAspectDecl_compute() {  return false;  }
            ...
            if(isFinal && num == boundariesCrossed)
{
    ...
    private boolean isCircularWithoutDeclareParents_compute() {  return false;  }

    protected boolean introducedInterfaces_computed = false;
    protected Collection introducedInterfaces_value;
    // Declared in DeclareParentsAnalysis.jrag at line 395
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedInterfaces() {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 486
 @SuppressWarnings({"unchecked", "cast"})     public boolean affectedByDeclareParents() {
        boolean affectedByDeclareParents_value = affectedByDeclareParents_compute();
        return affectedByDeclareParents_value;
    }

    private boolean affectedByDeclareParents_compute() {  return !declareParentsImplements().isEmpty() || !declareParentsExtends().isEmpty();  }

    protected java.util.Map precedes_TypeDecl_values;
    // Declared in DeclarePrecedenceNameAnalysis.jrag at line 12
 @SuppressWarnings({"unchecked", "cast"})     public boolean precedes(TypeDecl typeDecl) {
        Object _parameters = typeDecl;
if(precedes_TypeDecl_values == null) precedes_TypeDecl_values = new java.util.HashMap(4);
        if(precedes_TypeDecl_values.containsKey(_parameters))
            return ((Boolean)precedes_TypeDecl_values.get(_parameters)).booleanValue();
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        boolean precedes_TypeDecl_value = precedes_compute(typeDecl);
        if(isFinal && num == boundariesCrossed)
            precedes_TypeDecl_values.put(_parameters, Boolean.valueOf(precedes_TypeDecl_value));
        return precedes_TypeDecl_value;
    }

    private boolean precedes_compute(TypeDecl typeDecl) {
    ...
    protected boolean introducedConstructors_computed = false;
    protected Collection introducedConstructors_value;
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 176
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedConstructors() {
        if(introducedConstructors_computed)
            return introducedConstructors_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        introducedConstructors_value = introducedConstructors_compute();
        if(isFinal && num == boundariesCrossed)
            introducedConstructors_computed = true;
        return introducedConstructors_value;
    }

    private Collection introducedConstructors_compute() {
    Collection c = new ArrayList();
    ...
    protected boolean intertypeDecls_computed = false;
    protected Collection intertypeDecls_value;
    // Declared in IntertypeDecls.jrag at line 34
 @SuppressWarnings({"unchecked", "cast"})     public Collection intertypeDecls() {
        if(intertypeDecls_computed)
            return intertypeDecls_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        intertypeDecls_value = intertypeDecls_compute();
        if(isFinal && num == boundariesCrossed)
            intertypeDecls_computed = true;
        return intertypeDecls_value;
    }

    private Collection intertypeDecls_compute() {  return intertypeDecls(this);  }

    protected boolean intertypeParentDecls_computed = false;
    protected Collection intertypeParentDecls_value;
    // Declared in IntertypeDecls.jrag at line 68
 @SuppressWarnings({"unchecked", "cast"})     public Collection intertypeParentDecls() {
        if(intertypeParentDecls_computed)
            return intertypeParentDecls_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        intertypeParentDecls_value = intertypeParentDecls_compute();
        if(isFinal && num == boundariesCrossed)
            intertypeParentDecls_computed = true;
        return intertypeParentDecls_value;
    }

    private Collection intertypeParentDecls_compute() {  return intertypeParentDecls(this);  }

    // Declared in IntertypeFieldCodegeneration.jrag at line 92
 @SuppressWarnings({"unchecked", "cast"})     public String abcMangledName() {
        String abcMangledName_value = abcMangledName_compute();
        return abcMangledName_value;
    }

    private String abcMangledName_compute() {  return jvmName().replace('.', '_');  }

    protected boolean introducedFields_computed = false;
    protected Collection introducedFields_value;
    // Declared in IntertypeFieldNameAnalysis.jrag at line 102
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedFields() {
        if(introducedFields_computed)
            return introducedFields_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        introducedFields_value = introducedFields_compute();
        if(isFinal && num == boundariesCrossed)
            introducedFields_computed = true;
        return introducedFields_value;
    }

    private Collection introducedFields_compute() {
    Collection c = new ArrayList();
    for(Iterator iter = intertypeDecls().iterator(); iter.hasNext(); ) {
      ASTNode node = (ASTNode)iter.next();
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 280
 @SuppressWarnings({"unchecked", "cast"})     public HashMap localIntertypeMethodsSignatureMap() {
    ...
    private HashMap localIntertypeMethodsSignatureMap_compute() {  return new HashMap();  }

    protected boolean introducedMethods_computed = false;
    protected Collection introducedMethods_value;
    // Declared in IntertypeMethodNameAnalysis.jrag at line 242
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedMethods() {
        if(introducedMethods_computed)
            return introducedMethods_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        introducedMethods_value = introducedMethods_compute();
        if(isFinal && num == boundariesCrossed)
            introducedMethods_computed = true;
        return introducedMethods_value;
    }

    private Collection introducedMethods_compute() {
    Collection c = new ArrayList();
    for(Iterator iter = intertypeDecls().iterator(); iter.hasNext(); ) {
      ASTNode node = (ASTNode)iter.next();
    ...
    // Declared in IntertypeJimple15.jrag at line 154
 @SuppressWarnings({"unchecked", "cast"})     public SootClass getSootClassDecl() {
    ...
    erasure().getSootClassDecl() : refined_AspectJCodegen_getSootClassDecl();  }
...
if(createEnumArray_TypeDecl_values == null) createEnumArray_TypeDecl_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet bridgeCandidates(String signature) {
    ...
    protected boolean abcClass_computed = false;
    protected AbcClass abcClass_value;
    // Declared in AspectJCodegen.jrag at line 31
 @SuppressWarnings({"unchecked", "cast"})     public AbcClass abcClass() {
    ...
    protected boolean abcType_computed = false;
    protected AbcType abcType_value;
    // Declared in AspectJCodegen.jrag at line 37
 @SuppressWarnings({"unchecked", "cast"})     public AbcType abcType() {
        if(abcType_computed)
            return abcType_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        abcType_value = abcType_compute();
        if(isFinal && num == boundariesCrossed)
            abcType_computed = true;
        return abcType_value;
    }

    private AbcType abcType_compute() {  return AbcFactory.AbcType(getSootType());  }

    // Declared in AspectJNameAnalysis.jrag at line 25
 @SuppressWarnings({"unchecked", "cast"})     public boolean implement(TypeDecl typeDecl) {
        boolean implement_TypeDecl_value = implement_compute(typeDecl);
        return implement_TypeDecl_value;
    }

    private boolean implement_compute(TypeDecl typeDecl) {  return false;  }

    // Declared in PatternsCodegen.jrag at line 638
 @SuppressWarnings({"unchecked", "cast"})     public Set superTypes() {
        Set superTypes_value = superTypes_compute();
        return superTypes_value;
    }

    private Set superTypes_compute() {
        Set set = new HashSet();
        addSuperTypes(set);
        return set;
    }

    // Declared in Pointcuts.jrag at line 246
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet lookupMemberPointcut(String name) {
    ...
    // Declared in Pointcuts.jrag at line 257
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet lookupInheritedPointcut(String name) {
    ...
    private SimpleSet lookupInheritedPointcut_compute(String name) {  return SimpleSet.emptySet;  }

    protected boolean inheritedPointcuts_computed = false;
    protected Set inheritedPointcuts_value;
    // Declared in Pointcuts.jrag at line 491
 @SuppressWarnings({"unchecked", "cast"})     public Set inheritedPointcuts() {
        if(inheritedPointcuts_computed)
            return inheritedPointcuts_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        inheritedPointcuts_value = inheritedPointcuts_compute();
        if(isFinal && num == boundariesCrossed)
            inheritedPointcuts_computed = true;
        return inheritedPointcuts_value;
    }

    private Set inheritedPointcuts_compute() {
    ...
    // Declared in Privileged.jrag at line 27
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPrivileged() {
        boolean isPrivileged_value = isPrivileged_compute();
        return isPrivileged_value;
    }

    private boolean isPrivileged_compute() {  return getModifiers().isPrivileged() || isNestedType() && enclosingType().isPrivileged();  }
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public GLBType lookupGLBType(ArrayList bounds) {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 450
 @SuppressWarnings({"unchecked", "cast"})     public Collection declareParentsExtends() {
        Collection declareParentsExtends_value = getParent().Define_Collection_declareParentsExtends(this, null);
        return declareParentsExtends_value;
    }

    // Declared in DeclareParentsAnalysis.jrag at line 468
 @SuppressWarnings({"unchecked", "cast"})     public Collection declareParentsImplements() {
        Collection declareParentsImplements_value = getParent().Define_Collection_declareParentsImplements(this, null);
        return declareParentsImplements_value;
    }

    // Declared in DeclarePrecedenceNameAnalysis.jrag at line 29
 @SuppressWarnings({"unchecked", "cast"})     public Collection declarePrecedence() {
        Collection declarePrecedence_value = getParent().Define_Collection_declarePrecedence(this, null);
        return declarePrecedence_value;
    }

    // Declared in IntertypeDecls.jrag at line 35
 @SuppressWarnings({"unchecked", "cast"})     public Collection intertypeDecls(TypeDecl type) {
        Collection intertypeDecls_TypeDecl_value = getParent().Define_Collection_intertypeDecls(this, null, type);
        return intertypeDecls_TypeDecl_value;
    }

    // Declared in IntertypeDecls.jrag at line 69
 @SuppressWarnings({"unchecked", "cast"})     public Collection intertypeParentDecls(TypeDecl type) {
        Collection intertypeParentDecls_TypeDecl_value = getParent().Define_Collection_intertypeParentDecls(this, null, type);
        return intertypeParentDecls_TypeDecl_value;
    }

    // Declared in Pointcuts.jrag at line 229
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet lookupPointcut(String name) {
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 45
    ...
    // Declared in Patterns.jrag at line 50
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in AdviceCodegen.jrag at line 26
    public Aspect Define_Aspect_aspectClass(ASTNode caller, ASTNode child) {
        if(caller == getBodyDeclListNoTransform()) {
      int childIndex = caller.getIndexOfChild(child);
            return globalAspectInfo().getAspect(abcClass());
        }
        return getParent().Define_Aspect_aspectClass(this, caller);
    }
    ...
    // Declared in Pointcuts.jrag at line 232
   ...
   int i = caller.getIndexOfChild(child);
{
        ...
        return getParent().Define_SimpleSet_lookupPointcut(this, caller, name);
    }
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in PatternsCodegen.jrag at line 490
    ...
    // Declared in IntertypeConstructorNameAnalysis.jrag at line 40
    public TypeDecl Define_TypeDecl_visibilityContext(ASTNode caller, ASTNode child) {
        if(true) {
      int childIndex = this.getIndexOfChild(caller);
            return this;
        }
        return getParent().Define_TypeDecl_visibilityContext(this, caller);
    }
