...
public class DeclareParentsImplements extends BodyDecl implements Cloneable {
    public void flushCache() {
     ...
     @SuppressWarnings({"unchecked", "cast"})  public DeclareParentsImplements clone() throws CloneNotSupportedException {
        DeclareParentsImplements node = (DeclareParentsImplements)super.clone();
        node.in$Circle(false);
        node.is$Final(false);
    return node;
    }
     @SuppressWarnings({"unchecked", "cast"})  public DeclareParentsImplements copy() {
      try {
          DeclareParentsImplements node = (DeclareParentsImplements)clone();
     ...
     @SuppressWarnings({"unchecked", "cast"})  public DeclareParentsImplements fullCopy() {
        DeclareParentsImplements res = (DeclareParentsImplements)copy();
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 477
  ...
  protected void collectIntertypeParentDecls(HashMap map) {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 495
  ...
  public void generateIntertypeDecls() {
    ...
    // Declared in DeclareParentsPrettyPrint.jrag at line 22
  ...
  public void toString(StringBuffer s) {
    ...
    // Declared in AspectJ.ast line 38
    ...
    // Declared in AspectJ.ast line 38
    public DeclareParentsImplements(Pattern p0, List<Access> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in Patterns.jrag at line 145
