...
public class MethodAccess extends Access implements Cloneable {
  ...
  public TypeDecl superAccessorTarget() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 121
  ...
  public ASTNode boundCopy() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 227
  ...
  public void generateSuperDispatchDelegate(TypeDecl typeDecl) {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 237
  ...
  public void generateIntertypeDecls() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 259



  public MethodDecl superDispatchDelegate() {
    if(!needsSuperDispatchDelegate())
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in DeclareCodegen.jrag at line 66
  ...
  // refine old type checking to be valid when using variable arity parameters
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 487


    public void refined_IntertypeMethodCodegeneration_transformation() {
    if(needsSuperDispatchDelegate()) {
      if(Program.verbose())
        System.out.println("May need super dispatch delegate for " + this);
      SimpleSet maxSpecific = SimpleSet.emptySet;
    ...
    private SootMethodRef refined_GenericsCodegen_sootRef() {
    MethodDecl decl = decl().erasedMethod();
    ...
    // Declared in IntertypeJimple15.jrag at line 68
  public void transformation() {
    ...
    refined_IntertypeMethodCodegeneration_transformation();
  }

    // Declared in IntertypeJimple15.jrag at line 90
  private SootMethodRef sootRef() {
    ...
    return refined_GenericsCodegen_sootRef();
  }
...
if(computeDAbefore_int_Variable_values == null) computeDAbefore_int_Variable_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public MethodDecl decl() {
    ...
    // Declared in Privileged.jrag at line 113
...
if(typeArguments_MethodDecl_values == null) typeArguments_MethodDecl_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean invokesVariableArityAsArray() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 204
 @SuppressWarnings({"unchecked", "cast"})     public boolean needsSuperDispatchDelegate() {
        boolean needsSuperDispatchDelegate_value = needsSuperDispatchDelegate_compute();
        return needsSuperDispatchDelegate_value;
    }

    private boolean needsSuperDispatchDelegate_compute() {
    ...
    // Declared in IntertypeMethodCodegeneration.jrag at line 251
 @SuppressWarnings({"unchecked", "cast"})     public TypeDecl superDispatchQualifier() {
        TypeDecl superDispatchQualifier_value = superDispatchQualifier_compute();
        return superDispatchQualifier_value;
    }

    private TypeDecl superDispatchQualifier_compute() {
    if(!needsSuperDispatchDelegate())
