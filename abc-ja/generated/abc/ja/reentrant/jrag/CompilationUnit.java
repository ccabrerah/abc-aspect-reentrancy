...
public class CompilationUnit extends ASTNode<ASTNode> implements Cloneable {
  ...
  public void transformation() {
    ...
    // Declared in IntertypeDecls.jrag at line 18

  public boolean weavableClass = false;

    // Declared in IntertypeDecls.jrag at line 61
  ...
  protected void collectIntertypeDecls(HashMap map) {
    ...
    // Declared in IntertypeDecls.jrag at line 90
...
private SimpleSet refined_LookupType_Child_lookupType_String(String name)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public Collection importedMethodsOnDemand(String name) {
    ...
    // Declared in IntertypeDecls.jrag at line 17
 @SuppressWarnings({"unchecked", "cast"})     public boolean weavable() {
        boolean weavable_value = weavable_compute();
        return weavable_value;
    }

    private boolean weavable_compute() {  return fromSource() || weavableClass;  }
