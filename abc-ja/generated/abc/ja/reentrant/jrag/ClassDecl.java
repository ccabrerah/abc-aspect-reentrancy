...
public class ClassDecl extends ReferenceType implements Cloneable {
    public void flushCache() {
        ...
        introducedSuperclass_computed = false;
        introducedSuperclass_value = null;
     ...
     @SuppressWarnings({"unchecked", "cast"})  public ClassDecl clone() throws CloneNotSupportedException {
        ...
        node.introducedSuperclass_computed = false;
        node.introducedSuperclass_value = null;
 ...
 public void checkModifiers() {
  ...
  public ClassDecl refined_TypeAnalysis_superclass() {
    if(isObject())
      return null;
  ...
  private void refined_TypeHierarchyCheck_interfaceMethodCompatibleWithInherited(MethodDecl m, MethodDecl n) {
    if(n.isStatic())
  ...
  public ClassDecl p(Parameterization parTypeDecl) {
    ...
    // Declared in AspectErrorCheck.jrag at line 34


  public void refined_AspectErrorCheck_typeCheck() {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 135

  
  public ClassDecl superclassWithoutDeclareParents() {
    if(isObject())
      return null;
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 217


  public Iterator interfacesIteratorWithoutDeclareParents() {
    return new Iterator() {
      public boolean hasNext() {
        computeNextCurrent();
        return current != null;
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 502

  public boolean isPublic() {
    return super.isPublic() || mustBePublic;
  }

    // Declared in IntertypeMethodCodegeneration.jrag at line 27


  public void refined_IntertypeMethodCodegeneration_generateIntertypeDecls() {
  ...
  public void jimplify1phase2() {
    ...
    // Declared in AspectJCodegen.jrag at line 206
  ...
  public void jimplify1phase1() {
    ...
    // Declared in PatternsCodegen.jrag at line 645
    ...
    // Declared in Pointcuts.jrag at line 500
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 175
    ...
    return refined_TypeAnalysis_superclass();
  }

    // Declared in DeclareParentsAnalysis.jrag at line 181
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 241


    private void interfaceMethodCompatibleWithInherited(MethodDecl m, MethodDecl n) {
    if(m.isAbstract())
      refined_TypeHierarchyCheck_interfaceMethodCompatibleWithInherited(m, n);
  }

    // Declared in DeclareParentsAnalysis.jrag at line 76


    public void refined_DeclareParentsAnalysis_typeCheck() {
    refined_AspectErrorCheck_typeCheck();
    ...
    // Declared in IntertypeFieldCodegeneration.jrag at line 20


    public void generateIntertypeDecls() {
    refined_IntertypeMethodCodegeneration_generateIntertypeDecls();
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 120



  
    public void typeCheck() {
    refined_DeclareParentsAnalysis_typeCheck();
...
private SimpleSet refined_LookupMethod_ancestorMethods_String(String signature)
{
...
private boolean refined_TypeAnalysis_castingConversionTo_TypeDecl(TypeDecl type)
{
    ...
    // Declared in TypeAnalysis.jrag at line 675
...
private boolean refined_Generics_castingConversionTo_TypeDecl(TypeDecl type)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public HashMap interfacesMethodsSignatureMap() {
    ...
    // Declared in IntertypeMethodNameAnalysis.jrag at line 91
 @SuppressWarnings({"unchecked", "cast"})     public HashMap methodsSignatureMap() {
    ...
    // Declared in IntertypeMethodNameAnalysis.jrag at line 252
...
if(ancestorMethods_String_values == null) ancestorMethods_String_values = new java.util.HashMap(4);
    ...
    SimpleSet set = refined_LookupMethod_ancestorMethods_String(signature);
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 143
...
if(memberFields_String_values == null) memberFields_String_values = new java.util.HashMap(4);
    ...
    // Declared in IntertypeMethodErrorCheck.jrag at line 293
            ...
            if(isFinal && num == boundariesCrossed)
{
    ...
    protected boolean introducedSuperclass_computed = false;
    protected ClassDecl introducedSuperclass_value;
    // Declared in DeclareParentsAnalysis.jrag at line 381
 @SuppressWarnings({"unchecked", "cast"})     public ClassDecl introducedSuperclass() {
        if(introducedSuperclass_computed)
            return introducedSuperclass_value;
        int num = boundariesCrossed;
        boolean isFinal = this.is$Final();
        introducedSuperclass_value = introducedSuperclass_compute();
        if(isFinal && num == boundariesCrossed)
            introducedSuperclass_computed = true;
        return introducedSuperclass_value;
    }

    private ClassDecl introducedSuperclass_compute() {
    for(Iterator iter = declareParentsExtends().iterator(); iter.hasNext(); ) {
      DeclareParentsExtends e = (DeclareParentsExtends)iter.next();
      if(e.getPattern().matchesType(this)) {
        for(int i = 0; i < e.getNumTypeAccess(); i++) {
    ...
    // Declared in DeclareParentsAnalysis.jrag at line 409
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedInterfaces() {
    ...
    // Declared in IntertypeFieldNameAnalysis.jrag at line 121
 @SuppressWarnings({"unchecked", "cast"})     public Collection introducedFieldsFromInterfaces() {
        Collection introducedFieldsFromInterfaces_value = introducedFieldsFromInterfaces_compute();
        return introducedFieldsFromInterfaces_value;
    }

    private Collection introducedFieldsFromInterfaces_compute() {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet bridgeCandidates(String signature) {
    ...
    // Declared in AspectJCodegen.jrag at line 35
 @SuppressWarnings({"unchecked", "cast"})     public AbcClass abcClass() {
    ...
    // Declared in AspectJNameAnalysis.jrag at line 26
 @SuppressWarnings({"unchecked", "cast"})     public boolean implement(TypeDecl typeDecl) {
    ...
    private boolean implement_compute(TypeDecl typeDecl) {
    for(int i = 0; i < getNumImplements(); i++)
    ...
    // Declared in AspectJNameAnalysis.jrag at line 74
 @SuppressWarnings({"unchecked", "cast"})     public boolean isPerObject() {
    ...
    // Declared in Pointcuts.jrag at line 260
